...
| CI ID        | CI명                         | 파일명            | 유형 | 버전 | 날짜       | 상태  | 보관 위치             | 담당자              |
| ------------ | ---------------------------- | ----------------- | ---- | ---- | ---------- | ----- | --------------------- | ------------------- |
| SUP8-CI-0015 | 임시 메인 소스 (placeholder) | main.c            | SRC  | v1.0 | 2026-04-11 | Draft | src/main.c            | ASPICE SWE-3 전문가 |
| SUP8-CI-0016 | Calculator 클래스 헤더       | Calculator.h      | SRC  | v1.0 | 2026-04-11 | Draft | src/Calculator.h      | ASPICE SWE-3 전문가 |
| SUP8-CI-0017 | Calculator 클래스 구현       | Calculator.cpp    | SRC  | v1.0 | 2026-04-11 | Draft | src/Calculator.cpp    | ASPICE SWE-3 전문가 |
| SUP8-CI-0018 | InputParser 클래스 헤더      | InputParser.h     | SRC  | v1.0 | 2026-04-11 | Draft | src/InputParser.h     | ASPICE SWE-3 전문가 |
| SUP8-CI-0019 | InputParser 클래스 구현      | InputParser.cpp   | SRC  | v1.0 | 2026-04-11 | Draft | src/InputParser.cpp   | ASPICE SWE-3 전문가 |
| SUP8-CI-0020 | AppController 클래스 헤더    | AppController.h   | SRC  | v1.0 | 2026-04-11 | Draft | src/AppController.h   | ASPICE SWE-3 전문가 |
| SUP8-CI-0021 | AppController 클래스 구현    | AppController.cpp | SRC  | v1.0 | 2026-04-11 | Draft | src/AppController.cpp | ASPICE SWE-3 전문가 |
| SUP8-CI-0022 | 공통 타입 헤더               | types.h           | SRC  | v1.0 | 2026-04-11 | Draft | src/types.h           | ASPICE SWE-3 전문가 |
| SUP8-CI-0023 | CLI 진입점                   | main.cpp          | SRC  | v1.0 | 2026-04-11 | Draft | src/main.cpp          | ASPICE SWE-3 전문가 |

### 1.7 테스트 산출물 (TEST / SWE-4~6, 예정)
...
| -------------------- | ------- | --------------------- | ---------------- |
| PLAN                 | 3       | 3                     | 0                |
| DOC (SWE-1~3, SPL-2) | 11      | 11                    | 0                |
| BUILD                | 1       | 1                     | 0                |
| SRC                  | 9       | 9 (main.c + 구현 8종) | 0                |
| TEST                 | 7       | 0                     | 7 (SWE-4~6 대기) |
| **합계**             | **31**  | **31**                | **0**            |
...
| SWE-4~6 산출물 7종                                                 | SUP8-CI-0024~0030 | 단위·통합·적격성 TC 및 결과                | —    | — (미등록)    | 미작성   | SUP1-NC-0002 대응            |

---

## 4. 베이스라인 (Baseline) 목록

### 4.1 SUP8-BL-0001 — 개발 초기 베이스라인

| 항목         | 내용                                                                |
| ------------ | ------------------------------------------------------------------- |
| ID           | SUP8-BL-0001                                                        |
| 베이스라인명 | 개발 초기 베이스라인 (Development Initial Baseline)                 |
| 설정 조건    | SWE-1/2/3 산출물 Draft 완성, SPL-2 빌드 환경 구성 및 빌드 검증 완료 |
| 설정 날짜    | 2026-04-11                                                          |
| 승인자       | — (승인 대기)                                                       |
| 상태         | Draft                                                               |
...
| CI ID        | CI명                                | 버전 | 상태     |
| ------------ | ----------------------------------- | ---- | -------- |
| SUP8-CI-0001 | 프로젝트 계획서                     | v1.0 | Draft    |
| SUP8-CI-0002 | 형상 관리 계획서                    | v1.0 | Draft    |
| SUP8-CI-0003 | QA 감사 보고서                      | v1.0 | Draft    |
| SUP8-CI-0004 | SW 요구사항 명세서                  | v1.0 | Approved |
| SUP8-CI-0005 | SWE-1 추적성 매핑·리뷰              | v1.0 | Approved |
| SUP8-CI-0006 | SW 아키텍처 설계서                  | v1.0 | Draft    |
| SUP8-CI-0007 | SWE-2 추적성 매핑·리뷰              | v1.0 | Draft    |
| SUP8-CI-0008 | SW 단위 상세 설계 명세서            | v1.0 | Draft    |
| SUP8-CI-0009 | SWE-3 추적성 매핑·리뷰              | v1.0 | Draft    |
| SUP8-CI-0010 | 빌드 환경 및 활동 정의서            | v1.0 | Draft    |
| SUP8-CI-0011 | 피처 모델                           | v1.0 | Draft    |
| SUP8-CI-0012 | 출시 노트                           | v1.0 | Draft    |
| SUP8-CI-0013 | SPL-2 추적성 매핑·리뷰              | v1.0 | Draft    |
| SUP8-CI-0014 | 루트 빌드 스크립트 (CMakeLists.txt) | v1.0 | Draft    |
| SUP8-CI-0015 | 임시 메인 소스 (src/main.c)         | v1.0 | Draft    |

**미포함 CI 및 사유:**

| CI ID             | CI명                             | 미포함 사유                |
| ----------------- | -------------------------------- | -------------------------- |
| SUP8-CI-0016~0023 | SWE-3 구현 소스파일 6종+main.cpp | 아직 미작성 (SUP1-NC-0003) |
| SUP8-CI-0024~0030 | SWE-4~6 산출물 7종               | 아직 미착수 (SUP1-NC-0002) |

### 4.2 예정 베이스라인

| ID           | 베이스라인명      | 설정 조건                                                    | 상태          |
| ------------ | ----------------- | ------------------------------------------------------------ | ------------- |
| SUP8-BL-0002 | 테스트 베이스라인 | SWE-4 단위 테스트 전체 Pass + 커버리지 100% + 구현 소스 완성 | Open (미설정) |
| SUP8-BL-0003 | 통합 베이스라인   | SWE-5 통합 테스트 전체 Pass                                  | Open (미설정) |
| SUP8-BL-0004 | 릴리스 베이스라인 | SWE-6 적격성 테스트 전체 Pass + 전체 산출물 Approved         | Open (미설정) |
...
| CI ID             | CI명                | 현재 버전 | BL-0001 포함              | 미결 CR 수  | 최종 변경일 | 상태     |
| ----------------- | ------------------- | --------- | ------------------------- | ----------- | ----------- | -------- |
| SUP8-CI-0001      | 프로젝트 계획서     | v1.0      | ✅                        | 0           | 2026-04-05  | Draft    |
| SUP8-CI-0002      | 형상 관리 계획서    | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0003      | QA 감사 보고서      | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0004      | SW 요구사항 명세서  | v1.0      | ✅                        | 1 (CR-0002) | 2026-04-05  | Approved |
| SUP8-CI-0005      | SWE-1 추적성 매핑   | v1.0      | ✅                        | 1 (CR-0003) | 2026-04-05  | Approved |
| SUP8-CI-0006      | SW 아키텍처 설계서  | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0007      | SWE-2 추적성 매핑   | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0008      | SW 단위 상세 설계   | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0009      | SWE-3 추적성 매핑   | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0010      | 빌드 환경 정의서    | v1.0      | ✅                        | 0           | 2026-04-05  | Draft    |
| SUP8-CI-0011      | 피처 모델           | v1.0      | ✅                        | 0           | 2026-04-05  | Draft    |
| SUP8-CI-0012      | 출시 노트           | v1.0      | ✅                        | 0           | 2026-04-05  | Draft    |
| SUP8-CI-0013      | SPL-2 추적성 매핑   | v1.0      | ✅                        | 0           | 2026-04-05  | Draft    |
| SUP8-CI-0014      | 빌드 스크립트       | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0015      | 임시 메인 소스      | v1.0      | ✅                        | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0016~0023 | SWE-3 구현 소스 8종 | v1.0      | ✅ BL-0001 포함           | 0           | 2026-04-11  | Draft    |
| SUP8-CI-0024~0030 | SWE-4~6 산출물 7종  | v1.0      | ✅ BL-0002/0003/0004 포함 | 0           | 2026-04-11  | Draft    |
...
| #   | 체크 항목                                       | 결과   | 비고                                         |
| --- | ----------------------------------------------- | ------ | -------------------------------------------- |
| 1   | 모든 존재하는 산출물 파일에 CI ID가 부여됨      | ☑ 적합 | SUP8-CI-0001~0015 (현존 파일 15종 전부 등록) |
| 2   | 예정 산출물 (미작성)도 CI ID가 예약됨           | ☑ 적합 | SUP8-CI-0016~0030 예약 등록                  |
| 3   | CI 유형 분류 (PLAN/DOC/BUILD/SRC/TEST)가 명확함 | ☑ 적합 | §1 유형 컬럼 전부 기재                       |
| 4   | CI 보관 위치가 명시됨                           | ☑ 적합 | 파일 상대경로 기재                           |
| 5   | CI 담당자가 지정됨                              | ☑ 적합 | 각 전문가 에이전트 지정                      |

### 7.2 베이스라인 완전성

| #   | 체크 항목                                         | 결과     | 비고                                           |
| --- | ------------------------------------------------- | -------- | ---------------------------------------------- |
| 6   | 베이스라인 ID가 부여됨 (SUP8-BL-XXXX)             | ☑ 적합   | SUP8-BL-0001~0004                              |
| 7   | 베이스라인별 포함 CI 목록이 명시됨                | ☑ 적합   | §4.1 포함 CI 15종 목록                         |
| 8   | 미포함 CI에 미포함 사유가 명시됨                  | ☑ 적합   | 미작성/미착수 사유 기재                        |
| 9   | 베이스라인 승인자가 지정됨                        | ☒ 미완료 | SUP8-BL-0001 승인자 미지정 — SUP1-NC-0001 연관 |
| 10  | 예정 베이스라인 (BL-0002~0004) 설정 조건이 명시됨 | ☑ 적합   | §4.2 설정 조건 기재                            |

### 7.3 변경 제어 완전성

| #   | 체크 항목                                    | 결과     | 비고                             |
| --- | -------------------------------------------- | -------- | -------------------------------- |
| 11  | 승인된 변경 요청만 구현됨 (미승인 변경 없음) | ☑ 적합   | 현 시점 미구현 CR만 기록됨       |
| 12  | 모든 CR에 고유 ID (SUP8-CR-XXXX)가 부여됨    | ☑ 적합   | SUP8-CR-0001~0003                |
| 13  | 모든 CR에 영향 CI ID가 명시됨                | ☑ 적합   | §5 영향 CI ID 컬럼 기재          |
| 14  | 모든 CR에 CCB 결정이 기록됨                  | ☒ 미완료 | CCB 아직 미개최 — 승인 권고 상태 |
| 15  | 미결 CR이 형상 상태 보고에 반영됨            | ☑ 적합   | §6 미결 CR 수 컬럼 기재          |

### 7.4 추적성 완전성

| #   | 체크 항목                                | 결과   | 비고                    |
| --- | ---------------------------------------- | ------ | ----------------------- |
| 16  | SWE/SPL 산출물 ↔ CI ID 추적성 매핑 완료  | ☑ 적합 | §3 추적성 매핑표 완비   |
| 17  | 형상 상태 보고(CSA)가 최신 상태로 유지됨 | ☑ 적합 | §6 2026-04-11 기준 최신 |
| 18  | 버전 및 변경 이력이 기록됨               | ☑ 적합 | §8 변경 이력 기재       |
...
| 버전 | 날짜       | 변경 내용                                                                                                                                                                             | 작성자               |
| ---- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| v1.0 | 2026-04-11 | 최초 작성 — CI 31개 식별, BL-0001 정의, CR 3건 등록, CSA 작성, 감사 체크리스트 완료                                                                                                   | ASPICE SUP-8 전문가  |
| v1.1 | 2026-04-12 | SUP10-CR-0001 반영 — CI-0016~0023 보관 위치 수정(`src/calc_lib/` → `src/`; `include/types.h` → `src/types.h`; `src/cli/` → `src/`), 미작성 항목 완료로 콜 업데이트, CI 현황 요약 수정 | ASPICE SUP-10 전문가 |
