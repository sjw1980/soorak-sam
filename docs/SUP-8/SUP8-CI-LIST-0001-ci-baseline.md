...
| SUP8-CI-0016 | Calculator 클래스 헤더 | Calculator.h | SRC | — | — | 미작성 | src/calc_lib/Calculator.h (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0017 | Calculator 클래스 구현 | Calculator.cpp | SRC | — | — | 미작성 | src/calc_lib/Calculator.cpp (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0018 | InputParser 클래스 헤더 | InputParser.h | SRC | — | — | 미작성 | src/calc_lib/InputParser.h (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0019 | InputParser 클래스 구현 | InputParser.cpp | SRC | — | — | 미작성 | src/calc_lib/InputParser.cpp (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0020 | AppController 클래스 헤더 | AppController.h | SRC | — | — | 미작성 | src/cli/AppController.h (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0021 | AppController 클래스 구현 | AppController.cpp | SRC | — | — | 미작성 | src/cli/AppController.cpp (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0022 | 공통 타입 헤더 | types.h | SRC | — | — | 미작성 | include/types.h (예정) | ASPICE SWE-3 전문가 |
| SUP8-CI-0023 | CLI 진입점 | main.cpp | SRC | — | — | 미작성 | src/cli/main.cpp (예정) | ASPICE SWE-3 전문가 |
...
| BUILD | 1 | 1 | 0 |
| SRC | 9 | 1 (main.c) | 8 (Calculator, InputParser, AppController 등) |
...
| SUP8-CI-0016~0023 | SWE-3 구현 소스 8종 | — | ❌ 미포함 | 1 (CR-0001) | — | 미작성 |
| SUP8-CI-0024~0030 | SWE-4~6 산출물 7종 | — | ❌ 미포함 | 0 | — | 미착수 |
