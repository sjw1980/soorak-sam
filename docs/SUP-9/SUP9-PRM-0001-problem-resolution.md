...
- 모든 소스 파일은 `src/` 단일 디렉터리에 배치됨. `include/` 폴더는 `.gitkeep`만 보관 (퍼블릭 헤더 분리 계획 미실현 — SUP10-CR-0001로 문서 정정)
...
| v1.2 | 2026-04-12 | PR-0001 해결 결과 보완 — `include/` 미활용(SUP10-CR-0001) 사실 명시                         | ASPICE SUP-10 전문가 |
